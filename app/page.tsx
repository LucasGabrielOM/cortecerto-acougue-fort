...
export default function Home() {
  ...
  const [loginDraft, setLoginDraft] = useState({ username: "Vanusa", password: "" });
  ...
  const submitLogin = async (event: FormEvent) => {
    ...
    setError("");
    try {
      if (loginDraft.username.trim().toLowerCase() !== "vanusa") {
        throw new Error("Usuário ou senha incorretos.");
      }
      const { error: loginError } = await supabase.auth.signInWithPassword({
        email: "vanusa.alves@cortecerto.app",
  ...
  const logout = () => {
    ...
    setLoginDraft({ username: "Vanusa", password: "" });
    setData(null);
      ...
      <main className="login-page">
        ...
        <section className="login-form-panel">
          <form onSubmit={submitLogin}>
            ...
            <label>Usuário<input required readOnly autoComplete="username" value={loginDraft.username} aria-label="Usuário Vanusa" /></label>
